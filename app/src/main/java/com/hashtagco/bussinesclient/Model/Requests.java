...
public class Requests
{
    ...
    public Requests(String date ,String phoneClient, String name, String address, String status,
                    List<Order> foods, String latlng,  String paymentMethod, String paymentState, String phoneShipper) {
