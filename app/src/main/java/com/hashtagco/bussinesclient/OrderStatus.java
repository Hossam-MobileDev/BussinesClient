...
import com.hashtagco.bussinesclient.ViewHolder.OrderViewHolder;
...
*/
        ...
        Query getOrderByUser = table_requests.orderByChild("phoneClient").
        ...
        adapter = new FirebaseRecyclerAdapter<Requests, OrderViewHolder>(options) {
            ...
            @Override
            protected void onBindViewHolder(final OrderViewHolder holder,
                                            final int position, final Requests model) {
                ...
                final Requests clickItem = model;
                ...
                holder.btnTrackingShipper.setVisibility(View.GONE); //will hide the button and
                // space acquired by button
                ...
                if (adapter.getItem(position).getStatus().equals("2")) //shipping
                {
                    ...
                    holder.btnTrackingShipper.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view)
                        {
                            Intent intentTracing=new Intent(OrderStatus.
                                    this,TrackingShipper.class);
                            intentTracing.putExtra("Latlng",model.
                                    getLatlng());
                            intentTracing.putExtra("shipperPhone"
                                    ,model.getPhoneShipper());
